Product Requirements Document (PRD): Ground Truth 3D Commercial Renovation Project Page

1\. Overview

**Project Name:** Ground Truth 3D Website Content Update
...
* Right side for all browsers: “hamburger” dropdown menu  
  ...
  * OFFICE BUILDINGS \- links to /Office\_Commercial  
  * HOTELS AND HOSPITALITY FACILITIES \- Links to: /Hospitality  
  * RECREATIONAL FACILITIES \- Links to: /Rec\_Facility  
  * MANUFACTURING FACILITIES \- Links to: /Manufacturing\_Facility  
  * CAMPUSES AND PARKS \- Links to: /Campus  
  * RESTAURANTS \- Links to: /Restaurant   
  * RETAIL \- Links to: /Retail

2.1 Site Hero Image and Title Block

* **Hero image**: edge to edge maximum 250px tall centered on the page.   
  * Image asset: “commercial\_project\_page\_hero\_image.png”  
* **Title Block**:  
  * Title Block:“Commercial Existing Conditions Documentation (ECD)”  
* **Subtitle**:  overlaid on the Hero Image 5 px padding on the left side below the Title Block  
  * Subtitle: “The Foundation for Cost-Effective Commercial Renovation”  
* **Primary Call to Action (CTA):** “Get an Existing Conditions Documentation Quote”

2.2 Primary Descriptive Content

* **Content:**  
  The primary goal of any commercial building renovation is to cost-effectively increase the property’s value, whether by boosting worker productivity, improving lease rates, or increasing investment returns. Achieving project success is fundamentally dependent on a clear and easily communicated understanding of the building’s current state, which facilitates planning and helps prevent the conflict, delays, and rework that often afflict large-scale property alteration projects.What ECD Encompasses  
...
2.4 Content Break \- insert a link to “Read More” when Read More is clicked the remainder of the content is displayed
...
ECD projects frequently take place in occupied commercial buildings, introducing complexities like security concerns, privacy issues, and the potential for tenant interruption. Firms experienced in this area, such as Ground Truth 3D, utilize established processes to address challenging environments, including working with client security teams, using flexible scheduling (overnight and weekend scans), and securing all collected data with provisions to exclude sensitive areas from documentation.Overwhelming Value: Risk Mitigation and Efficiency
...
2.8	link \- “Download White Paper” \- links to: White Paper \- The Process and Value of ECD for Commercial Renovation Projects
